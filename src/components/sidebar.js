    ...
    <div className='m-1 row-1 d-sidebar'>
      <div className='mx-2 d-flex'>
        ...
        <div className='d-flex-col'>
          ...
          <h6 className='mx-1 mt-0'>YOUR INFO</h6>
        </div>
      </div>
      <div className='mx-2 mt-0 d-flex'>
        ...
        <div className='d-flex-col'>
          ...
          <h6 className='mx-1 mt-0'>SELECT PLAN</h6>
        </div>
      </div>
      <div className='mx-2 mt-0 d-flex'>
        ...
        <div className='d-flex-col'>
          ...
          <h6 className='mx-1 mt-0'>ADD-ONS</h6>
        </div>
      </div>
      <div className='mx-2 mt-0 d-flex'>
        ...
        <div className='d-flex-col'>
          ...
          <h6 className='mx-1 mt-0'>SUMMARY</h6>
        </div>
      </div>
    </div>
  );
